...
class ServerSave extends FormRequest
{
    ...
    private function getBaseRules(): array
    {
        return [
            ...
            'certificate_id' => 'nullable|string|max:64',
            'certificate_ref_mode' => 'nullable|string|in:server_certificate,path',
            ...
            'fallback_site' => 'nullable|array',
            'fallback_site.enabled' => 'nullable|boolean',
            'fallback_site.mode' => 'nullable|string|in:builtin,upload,proxy,raw',
            'fallback_site.template' => 'nullable|string|max:64',
            'fallback_site.asset' => 'nullable|string|max:255',
            'fallback_site.asset_name' => 'nullable|string|max:255',
            'fallback_site.raw' => 'nullable',
            'fallback_site.upstream' => 'nullable|array',
            'fallback_site.upstream.host' => 'nullable|string|max:253',
            'fallback_site.upstream.port' => 'nullable|integer|min:1|max:65535',
            'fallback_site.upstream.scheme' => 'nullable|string|in:auto,http,https',
