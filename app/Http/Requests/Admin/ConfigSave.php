...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'user_login_title' => 'nullable|string|max:120',
        'user_login_description' => 'nullable|string|max:500',
        'admin_login_background' => 'nullable|url:http,https|max:2048',
        'admin_login_glass_opacity' => 'nullable|integer|min:0|max:95',
        'admin_login_mask_opacity' => 'nullable|integer|min:0|max:90',
        'admin_login_theme_color' => ['nullable', 'string', 'max:20', 'regex:/^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/'],
        'user_hidden_menus' => 'nullable|array',
        'user_hidden_menus.*' => 'string|in:/usage,/leaderboard,/node-status,/invite,/tickets,/knowledge',
        'admin_hidden_menus' => 'nullable|array',
        'admin_hidden_menus.*' => 'string|in:/usage,/leaderboard,/commissions,/knowledge,/extensions',
        'user_support_enabled' => 'boolean',
        'user_support_description' => 'nullable|string|max:500',
        'user_support_telegram_label' => 'nullable|string|max:100',
        'user_support_telegram_url' => 'nullable|url:http,https|max:2048',
        'user_support_group_label' => 'nullable|string|max:100',
        'user_support_group_url' => 'nullable|url:http,https|max:2048',
        'user_support_ticket_enabled' => 'boolean',
        'user_support_knowledge_enabled' => 'boolean',
        // email
        'email_host' => '',
        'email_port' => '',
        'email_username' => '',
        ...
        'secure_path' => 'min:8|regex:/^[\w-]*$/|not_in:passport',
    ...
    public function messages()
    {
        ...
        return [
            ...
            'admin_login_theme_color.regex' => '登录页主题色必须是 # 开头的十六进制颜色值',
            'secure_path.min' => '后台路径长度最小为8位',
            'secure_path.regex' => '后台路径只能为字母或数字',
            'secure_path.not_in' => '后台路径不能使用系统保留路径',
